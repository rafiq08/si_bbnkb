...
if (isset($_GET['kode'])) {
	$sql_cek = "SELECT p.id_petugas_bbnkb, p.kode_petugas, p.nama_petugas, p.id_pelayanan, p.tahun_kerja, p.status_kerja, m.id_pindah, m.id_petugas_bbnkb, m.nopol, m.nama_stnk, m.alamat_lama, m.alamat_baru, m.tgl from tb_pindah_bjm_Ii m inner join tb_petugas_bbnkb p on p.id_petugas_bbnkb=m.id_petugas_bbnkb WHERE id_pindah='" . $_GET['kode'] . "'";
...
<div class="card card-success">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-edit"></i> Ubah Data Pindah Banjarmasin II Ke Banjarmasin I
		</h3>
	</div>
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<select name="id_petugas_bbnkb" id="id_petugas_bbnkb" class="form-control" data-error="wajib di isi" value="<?php echo $data_cek['nama_petugas']; ?>" required>
						<option selected="selected">- Pilih Kode Petugas-</option>
						<?php
...
if (isset($_POST['Ubah'])) {
	$sql_ubah = "UPDATE tb_pindah_bjm_ii SET 
