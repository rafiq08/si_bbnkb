<div class="card card-success">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-car"></i> Data Pindah Banjarmasin II Ke Banjarmasin I
		</h3>
	</div>
	<!-- /.card-header -->
	<div class="card-body">
		<div class="table-responsive">
			<div>
				<a href="?page=add-pindah_ii" class="btn btn-primary">
				...
				<tbody>
					...
					?>
						...
						<td class="text-center">
							...
							<td class="text-center">								
								<a href="?page=edit-pindah_ii&kode=<?php echo $data['id_pindah']; ?>" title="Ubah" class="btn btn-success btn-sm">
									<i class="fa fa-edit"></i>
								</a>
								<a href="?page=del-pindah_ii&kode=<?php echo $data['id_pindah']; ?>" onclick="return confirm('Apakah anda yakin hapus data ini ?')" title="Hapus" class="btn btn-danger btn-sm">
