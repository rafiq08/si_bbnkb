...
<div class="card card-success">
	<div class="card-header">
		<h3 class="card-title">
			<i class="fa fa-edit"></i> Ubah Data User</h3>
	</div>
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="username" name="username" value="<?php echo $data_cek['username']; ?>" required>
				</div>
			</div>
			...
			<div class="form-group row">
                ...
                if ($data_cek['level'] == "KASI Pelayanan PKB & BBNKB") echo "<option value='KASI Pelayanan PKB & BBNKB' selected>KASI Pelayanan PKB & BBNKB</option>";
                else echo "<option value='KASI Pelayanan PKB & BBNKB'>KASI Pelayanan PKB & BBNKB</option>";
            ?>
					</select>
				</div>
			</div>
